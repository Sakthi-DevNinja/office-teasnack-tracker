...
import { Receipt, Calendar, Printer, Cookie } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 print:block print:space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden print:border-black">
              <div className="bg-tea-600 text-white p-4 flex justify-between items-center print:bg-gray-100 print:text-black print:border-b print:border-black">
                  ...
                  <span className="text-sm opacity-90 print:hidden">Official Expense</span>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden print:border-black">
              <div className="bg-orange-600 text-white p-4 flex justify-between items-center print:bg-gray-100 print:text-black print:border-b print:border-black">
                  ...
                  <span className="text-sm opacity-90 print:hidden">Personal Expense</span>
              </div>
